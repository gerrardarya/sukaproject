...
export default function NewBannerPage() {
  ...
  useEffect(() => {
    supabase
      ...
      .select("sort_order")
      .then(({ data }) => {
        if (data) setTakenOrders(data.map((b) => b.sort_order));
      });
  }, []);
      ...
      <main className="ml-64 py-10 px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Add New Banner</h1>
              <p className="text-sm text-muted mt-0.5">Upload a banner image for your storefront</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                type="submit"
                disabled={saving || !imagePreview || isOrderTaken}
